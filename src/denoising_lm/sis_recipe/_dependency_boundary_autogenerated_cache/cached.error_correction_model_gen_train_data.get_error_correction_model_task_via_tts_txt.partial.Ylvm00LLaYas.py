...
_returnn_dataset_to_text_lines_job = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='QGc69f4FZ5RZ')
_returnn_dataset_to_text_lines_job1 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='OV3ZgIJGBI39')
_returnn_dataset_to_text_lines_job2 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='wKo6unvLiNKz')
_returnn_dataset_to_text_lines_job3 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='Gug78S5smFNP')
_returnn_dataset_to_text_lines_job4 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='EiDojkH12wre')
_returnn_dataset_to_text_lines_job5 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='kOetnkqoBbHj')
_returnn_dataset_to_text_lines_job6 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='9eqMXl4XziJ3')
_returnn_dataset_to_text_lines_job7 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='gyDPu35plEsH')
_returnn_dataset_to_text_lines_job8 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='PimzXFHHPVwZ')
_returnn_dataset_to_text_lines_job9 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='HwqqmTA0H14N')
_concatenate_job = make_fake_job(module='i6_core.text.processing', name='ConcatenateJob', sis_hash='stOZOv4wDVyT')
...
_returnn_dataset_to_text_lines_job12 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='2R0IjxpY9F0a')
_dict10 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job14 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='rD4Wr9Lziwiz')
_dict15 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job16 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='4vjXMUEM5zaC')
...
_returnn_dataset_to_text_lines_job18 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='oW9KYpT1vKyI')
...
_returnn_dataset_to_text_lines_job20 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='qcvPgMMBo5hx')
...
_returnn_dataset_to_text_lines_job22 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='iproDTz78bGI')
...
_returnn_dataset_to_text_lines_job24 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='vVAsR1Zd1zFL')
_dict35 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job25 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='UUFCq2O5uwxu')
_dict39 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job26 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='KlCn4KcGqDar')
_dict43 = {
    'class': 'LmDataset',
