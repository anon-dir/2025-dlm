...
_returnn_dataset_to_text_lines_job = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='VSf4PzmaiuJO')
_returnn_dataset_to_text_lines_job1 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='eyhGodD6Mzgn')
_returnn_dataset_to_text_lines_job2 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='4441d6vtyPxt')
_returnn_dataset_to_text_lines_job3 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='dc6olQuHiruk')
_returnn_dataset_to_text_lines_job4 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='KlAZOM2bAXIy')
_returnn_dataset_to_text_lines_job5 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='Zp5dWvxZ7hx0')
_returnn_dataset_to_text_lines_job6 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='7MWdbwjMDjdq')
_returnn_dataset_to_text_lines_job7 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='KqZNF18Io1Fy')
_returnn_dataset_to_text_lines_job8 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='lVzwgFNssAiP')
_returnn_dataset_to_text_lines_job9 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='cFUSj4v3ZgzP')
_concatenate_job = make_fake_job(module='i6_core.text.processing', name='ConcatenateJob', sis_hash='3RxtVWczoqQw')
...
_returnn_dataset_to_text_lines_job12 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='8paJvZHuK30o')
_dict10 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job14 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='cFm0dgFNdLC0')
_dict15 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job16 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='psFEWS90N2QU')
...
_returnn_dataset_to_text_lines_job18 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='TKshjkFcLJ5Z')
...
_returnn_dataset_to_text_lines_job20 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='cgRxBDsUqmTF')
...
_returnn_dataset_to_text_lines_job22 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='hckxJgfKf7pW')
...
_returnn_dataset_to_text_lines_job24 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='U9k8P1y0pSIE')
_dict35 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job25 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='FL7Zh2wiR0YE')
_dict39 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job26 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='CHVW6OdiM95Y')
_dict43 = {
    'class': 'LmDataset',
