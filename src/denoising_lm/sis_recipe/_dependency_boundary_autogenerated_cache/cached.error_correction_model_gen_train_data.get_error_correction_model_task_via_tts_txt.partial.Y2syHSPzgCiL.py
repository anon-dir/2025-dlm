...
_returnn_dataset_to_text_lines_job = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='4O5OktvIuSsH')
_returnn_dataset_to_text_lines_job1 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='9EBUKYFPhBCM')
_returnn_dataset_to_text_lines_job2 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='kMnak0KbZCzi')
_returnn_dataset_to_text_lines_job3 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='83Q16KpQrSeN')
_returnn_dataset_to_text_lines_job4 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='EA7v01IlDh9Q')
_returnn_dataset_to_text_lines_job5 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='cKih8xqp3WdE')
_returnn_dataset_to_text_lines_job6 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='TANEghjACv9z')
_returnn_dataset_to_text_lines_job7 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='8bdAs0hpSLnh')
_returnn_dataset_to_text_lines_job8 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='tGLoJ0e4NtU2')
_returnn_dataset_to_text_lines_job9 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='IDp3bawrtx1G')
_concatenate_job = make_fake_job(module='i6_core.text.processing', name='ConcatenateJob', sis_hash='GI5f30zVNTdt')
...
_returnn_dataset_to_text_lines_job12 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='wk8QOrnAAXTR')
_dict10 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job14 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='M3dB4FU2zDMC')
_dict15 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job16 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='gFUa2Trq44Sj')
...
_returnn_dataset_to_text_lines_job18 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='znFjtb8ndesb')
...
_returnn_dataset_to_text_lines_job20 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='JCU2QD7RDzGf')
...
_returnn_dataset_to_text_lines_job22 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='YJBOzyzqmH77')
...
_returnn_dataset_to_text_lines_job24 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='UbcwCi8Cq26L')
_dict35 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job25 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='P2po3cBVCFrL')
_dict39 = {
    'class': 'LmDataset',
...
_returnn_dataset_to_text_lines_job26 = make_fake_job(module='i6_experiments.users.zeyer.datasets.utils.serialize', name='ReturnnDatasetToTextLinesJob', sis_hash='Qcb7D8PVp6ww')
_dict43 = {
    'class': 'LmDataset',
